...
export OBSIDIAN_HF_PAPERS_DAILY="${OBSIDIAN_HF_PAPERS_DAILY:-$HOME/Obsidian/hf-papers/daily}"
export OBSIDIAN_HF_PAPERS_WEEKLY="${OBSIDIAN_HF_PAPERS_WEEKLY:-$HOME/Obsidian/hf-papers/weekly}"
