...
- Nemotron 3 Ultra: Open, {EfficientMixture}-of-Experts Hybrid Mamba-Transformer Model for Agentic {ReasoningNemotron} 3 Nano: Open, efficient Mixture-of-Experts hybrid Mamba-Transformer model for agentic reasoning
